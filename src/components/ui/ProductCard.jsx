    ...
    <div>
      <div className="relative  bg-gray-100 p-6">
       {/* <div className="absolute top-2 left-2 h-8 w-8 flex items-center justify-center"> */}
            <button className="absolute top-2 left-2 z-10 h-8 w-8 p-0 bg-white  flex items-center justify-center"><img src={eyeIcon} alt="Ver producto" className="absolute h-6 w-6 block " /></button>
